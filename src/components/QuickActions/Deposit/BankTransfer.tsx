        ...
        <div className='account-details flex flex-col gap-3'>
          <div className='flex gap-3 items-center'>
            ...
            <div>
              ...
              <div className='lg:text-xl text-lg tracking-wide font-medium'>{data?.data.account.account_number}</div>
            </div>
          </div>
          <div className='flex gap-3 items-center'>
            ...
            <div>
              ...
              <div className='lg:text-base text-sm'>{data?.data.account.bank_name}</div>
            </div>
          </div>
          <div className='flex gap-3 items-center'>
            ...
            <div>
              ...
              <div className='lg:text-base text-sm'>{data?.data.first_name} {data?.data.last_name}</div>
            </div>
          </div>
        ...
        <div className='procedure flex flex-col gap-2 lg:mr-6'>
          ...
          <ol type='1' className='flex flex-col gap-2 text-gray-500 lg:text-base text-sm'>
            <li>
              ...
              Copy the account details above. {data?.data.account.account_number} is your account number.
            </li>
            <li>
            ...
            <li>
              ...
              Transfer the desired amount to your <span className='lowercase'>{data?.data.account.bank_name}</span> account.
            </li>
          </ol>
        </div>
      </div>
